...
class NormalDistribution(Distribution):
    ...
    def expectation(self, func: Callable[[Information], float]) -> 'Distribution':   #Question here
...
class BootstrapDistribution(Distribution):
    def __init__(self, data: Information, sample_size: int | None = None):
        self.data = data
...
def bootstrap_distribution(data: Information, sample_size: int | None = None) -> Distribution:
